...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $existQuery = "SELECT * FROM `user` WHERE `username` = '$uname' OR `email` = '$email'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $sql = "INSERT INTO `user`(`name`, `email`, `username`, `password`) VALUES ('$name','$email','$uname','$hashedPass')";
...
?>
  ...
  <?php
    if ($showError == true) {
      ...
      <strong>' . htmlspecialchars("User Name Already Exists!") . '</strong> Try with different User Name.
