      ...
      <div class="container-fluid px-4">
        ...
        <div class="sidebar offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar"
          ...
          <div class="offcanvas-header border-bottom">
            ...
            <button type="button" class="btn-close btn-close-white text-reset shadow-none border-0"
          ...
          <div class="offcanvas-body">
            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
              ...
              <li class="nav-item">
                <a class="nav-link activeted" href="Projects.php">Projects</a>
              </li>
              <li class="nav-item">
        ...
        <div class="d-flex p-1 px-lg-5 mx-lg-5">
          <div class="px-lg-5">
            ...
            <div class="mt-5 d-flex align-items-center justify-content-center">
              <a name="" id="" class="btn rounded-5 text-white px-4 d-flex align-items-center justify-content-center"
                href="Login.html" role="button">Know More</a>
            </div>
          </div>
        </div>
      </div>
